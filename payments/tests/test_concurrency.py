...
# ✂️ Remove any proxy settings that might lie in the environment
for var in ('HTTP_PROXY','HTTPS_PROXY','http_proxy','https_proxy'):
    os.environ.pop(var, None)

# 🛑 Force requests to bypass proxies for localhost
os.environ['NO_PROXY'] = '127.0.0.1,localhost'
os.environ['no_proxy'] = '127.0.0.1,localhost'

import requests

# 🔧 Tell every Session (including the one behind requests.get/post) to ignore any env-based proxies
